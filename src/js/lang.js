...
const translations = {
    en: {
        ...
        msgUploadCompleteNewDraft: "Upload complete, all files in dataset. Close this window, refresh your dataset page, and navigate to the new DRAFT version to see the uploaded files, or click <a href=\"{0}\">here</a> to open the new draft version in this tab.",
    ...
    fr: {
        ...
        msgUploadCompleteNewDraft: "Envoi terminé, tous les fichiers sont dans le jeu de données. Fermez cette fenêtre, rafraîchissez la page de votre jeu de données, et accédez à la nouvelle version DRAFT pour voir les fichiers envoyés, ou cliquez <a href=\"{0}\">ici</a> pour ouvrir la nouvelle version brouillon dans cet onglet.",
